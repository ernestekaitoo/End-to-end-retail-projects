...
**[Click here to view the Interactive Dashboard](https://huggingface.co/spaces/Richkaitoo/retail_app)** *(Note: Free tier hosting may take 60 seconds to "wake up" if inactive.)*
